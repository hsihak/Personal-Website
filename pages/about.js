...
const About = () => {
  return (
    <>
      <div
        className='flex justify-center animate-fade-in-down md:h-screen'
        id='about'>
        <div className='flex flex-col items-center w-11/12 px-6 py-20 rounded-md md:w-3/5'>
          <Fade bottom cascade>
            ...
            <div className='flex flex-row'>
              <Fade bottom cascade duration={3000}>
                <div className='flex flex-col py-8 md:gap-20 md:flex-row'>
                  ...
                  <div className='flex flex-col gap-8 py-10  rounded-lg px-4 '>
                    ...
                    <p className=' animate-fade-in-up dark:font-light dark:text-gray-300'>
                      ...
                      explicabo, assumenda expedita quia culpa non cum officia
                      illo. Saepe eaque tempora voluptatum laboriosam commodi.
                      Voluptas minima enim optio inventore velit iusto, sit amet
                      quasi atque molestiae repellat dolor alias aliquam
                      cupiditate incidunt repellendus officiis labore vitae esse
                      doloribus fugit fuga corporis eveniet deserunt? Impedit
                      similique accusantium beatae porro? Quibusdam est numquam
                      ut ex sunt quas, dicta dolores cumque ratione sed
                      dignissimos ab. Quod id dolor vel iusto ipsa dolorum. Enim
                      sed possimus beatae aut, voluptatibus laborum laudantium
                      suscipit dolore repellat rerum quia. Magni distinctio
                      corrupti similique quod unde illum adipisci tempora
                      assumenda officiis suscipit. Ad quod error mollitia et
                      illum.
                    </p>
